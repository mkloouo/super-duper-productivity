...
- **Phase 2**: not started yet — paused here per the user's request to test the Phase 1 APK on Android before continuing into the (much larger) shell/component redesign.
